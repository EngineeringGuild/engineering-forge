...
// MongoDB connection string — read from environment, never hardcoded.
// The credential formerly hardcoded here was exposed in this public repo
// and MUST be rotated in MongoDB Atlas; see docs/03_DECISIONS.md DEC-010-007.
