...
import { ApiResponse, CreateProjectRequest, UpdateProjectRequest } from '../types/api.types';
 ...
 */
export async function addComponentToProject(req: Request, res: Response): Promise<void> {
  try {
    const { id } = req.params;
    ...
    const project = await projectService.addComponentToProject(id, userId, componentId);
 ...
 */
export async function removeComponentFromProject(req: Request, res: Response): Promise<void> {
  try {
    const { id, componentId } = req.params;
    const userId = req.userId!;

    const project = await projectService.removeComponentFromProject(id, userId, componentId);
 ...
 */
export async function getProjectStatistics(_req: Request, res: Response): Promise<void> {
  try {
