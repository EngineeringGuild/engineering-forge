...
import { ApiResponse, CreateComponentRequest, UpdateComponentRequest } from '../types/api.types';
 ...
 * Get component by ID
 */
export async function getComponentById(req: Request, res: Response): Promise<void> {
  try {
    const { id } = req.params;
...
export async function getComponents(req: Request, res: Response): Promise<void> {
  try {
    ...
    const unlocked =
      req.query.unlocked === 'true' ? true : req.query.unlocked === 'false' ? false : undefined;
 ...
 */
export async function unlockComponent(req: Request, res: Response): Promise<void> {
  try {
    const { id } = req.params;
 ...
 */
export async function getComponentsByType(req: Request, res: Response): Promise<void> {
  try {
 ...
 */
export async function getComponentsByRarity(req: Request, res: Response): Promise<void> {
  try {
 ...
 */
export async function getUnlockedComponents(req: Request, res: Response): Promise<void> {
  try {
    const userLevel = req.user?.statistics?.level || 1;
 ...
 */
export async function getComponentStatistics(_req: Request, res: Response): Promise<void> {
  try {
