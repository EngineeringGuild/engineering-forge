...
export class GameActionsService implements GameActions {
  ...
  addComponent(component: Component): void {
    this.updateState(state => {
      ...
      const existingComponent = state.workspaceComponents.find(c => c.type === component.type);
      if (existingComponent) {
        console.warn(`Component of type ${component.type} already exists in workspace`);
