    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <div className="w-full bg-white/10 rounded-full h-3 backdrop-blur-sm">
          <div
            className={`h-3 rounded-full transition-all duration-500 ease-out ${getPerformanceBarColor(
              (value / max) * 100
            )} shadow-md`}
      ...
      <div className="mb-8">
        ...
        <div className="relative">
          <div className="w-full bg-white/10 rounded-full h-4 backdrop-blur-sm">
            <div
              className={`h-4 rounded-full transition-all duration-500 ease-out ${getPerformanceBarColor(
                performance.overall
              )} shadow-lg`}
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div className="bg-gray-700 rounded p-2">
              ...
              <div className="text-white font-medium">
                {formatValue(performance.weight, "kg")}
              </div>
            </div>
            <div className="bg-gray-700 rounded p-2">
              <div className="text-gray-400">Power</div>
              <div className="text-white font-medium">
                {formatValue(performance.power, "HP")}
              </div>
            </div>
            <div className="bg-gray-700 rounded p-2">
              <div className="text-gray-400">Torque</div>
              <div className="text-white font-medium">
                {formatValue(performance.torque, "Nm")}
              </div>
            </div>
            <div className="bg-gray-700 rounded p-2">
